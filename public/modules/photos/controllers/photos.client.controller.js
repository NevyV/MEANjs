...
.controller('PhotosController', ['$scope', '$stateParams', '$location', '$http', 'Authentication', 'Socket', 'Photos',  
	function($scope, $stateParams, $location, $http, Authentication, Socket, Photos) {
